...
import com.zhongsou.spider.common.util.SuffixStringMatcher;
...
public class SuffixURLFilter implements URLFilter {
	...
	public static void main(String args[]) throws IOException {
		...
		if (args.length >= 1)
			...
			filter.setConf(SpiderConfiguration.create());
		}
	...
	public void setConf(Configuration conf) {
		...
		for (Map.Entry<Integer, PluginImplementation> entry : map.entrySet()) {
			if (entry.getValue().getClassName().equals(SuffixURLFilter.class.getName())) {
