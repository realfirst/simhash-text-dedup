...
import com.zhongsou.spider.common.util.PrefixStringMatcher;
import com.zhongsou.spider.common.util.TrieStringMatcher;
...
public class PrefixURLFilter implements URLFilter {
	...
	public void setConf(Configuration conf) {
		...
		for (Map.Entry<Integer, PluginImplementation> entry : map.entrySet()) {
			if (entry.getValue().getClassName().equals(PrefixURLFilter.class.getName())) {
				attributeFile = entry.getValue().getAttribute("file");
				break;
			}
