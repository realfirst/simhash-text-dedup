...
//	private static final Pattern MAIL_REGEX = Pattern.compile("[-_.0-9A-Za-z]+@[-_0-9A-Za-z]+[-_.0-9A-Za-z]+");
	//当遇到没有空格的文本，上面这个正则变的非常慢，需要几分钟才能完成匹配，因此，限制一下邮件的格式的正则
	private static final Pattern MAIL_REGEX = Pattern.compile("[-_.0-9A-Za-z]{1,20}@[-_0-9A-Za-z]{1,20}");
