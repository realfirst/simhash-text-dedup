...
public class DetectorFactory {
	...
	public static final String[] languages = new String[] { "af", "ar", "a.txt", "bg", "bn", "cs", "da", "de", "el", "en", "es", "et", "fa", "fi", "fr", "gu", "he", "hi", "hr", "hu", "id", "it",
			"ja", "kn", "ko", "lt", "lv", "mk", "ml", "mr", "ne", "nl", "no", "pa", "pl", "pt", "ro", "ru", "sk", "sl", "so", "sq", "sv", "sw", "ta", "te", "th", "tl", "tr", "uk", "ur", "vi",
			"zh-cn", "zh-tw" };

	static void loadDefaultResourceProfile() {
		int index = 0;
		...
		for (String lang : languages) {
			...
			try {
				input = DetectorFactory.class.getResourceAsStream("profiles/" + lang);
				if (input != null) {
					LangProfile profile = JSON.decode(input, LangProfile.class);
		...
		System.out.println("succeed load file " + index);
	}

	static private DetectorFactory instance_ = new DetectorFactory();

	static {
		loadDefaultResourceProfile();
	}
